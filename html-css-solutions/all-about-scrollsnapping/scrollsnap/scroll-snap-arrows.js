define(['scrollsnapapi'], function(scrollsnapapi) {
  
  var scrollSnapToNext = scrollsnapapi.scrollSnapToNext,
      getScrollSnapPositions = scrollsnapapi.getScrollSnapPositions;
